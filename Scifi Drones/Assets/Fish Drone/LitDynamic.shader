	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_MetallicTexture = input.ase_texcoord9.xy * _MetallicTexture_ST.xy + _MetallicTexture_ST.zw;
				
				float2 uv_RoughnessTexture = input.ase_texcoord9.xy * _RoughnessTexture_ST.xy + _RoughnessTexture_ST.zw;
				...
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = saturate( (_RemapMetallicMap.x + (tex2D( _MetallicTexture, uv_MetallicTexture ).r - 0.0) * (_RemapMetallicMap.y - _RemapMetallicMap.x) / (1.0 - 0.0)) );
				float Smoothness = saturate( (_RemapRoughness.x + (( 1.0 - tex2D( _RoughnessTexture, uv_RoughnessTexture ).r ) - 0.0) * (_RemapRoughness.y - _RemapRoughness.x) / (1.0 - 0.0)) );
				float Occlusion = 1;
				float Alpha = 1;
...
Node;AmplifyShaderEditor.SamplerNode;14;-1248,-512;Inherit;True;Property;_BaseColor;BaseColor;3;0;Create;True;0;0;0;False;0;False;-1;f399e5c1264bb144d81900b9589c9c91;f399e5c1264bb144d81900b9589c9c91;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleDivideOpNode;34;-800,64;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;3;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;30;-1024,96;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;37;-512,416;Inherit;False;Property;_RemapRoughness;RemapRoughness;8;0;Create;True;0;0;0;False;0;False;0,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;28;-352,192;Inherit;False;Property;_Smoothness;Smoothness;9;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RGBToHSVNode;15;-880,-544;Inherit;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleAddOpNode;19;-336,-624;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-640,-480;Inherit;False;Property;_H;H;4;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;31;-160,-560;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.HSVToRGBNode;23;176,-480;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;17;-880,-336;Inherit;False;Property;_S;S;5;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;20;-336,-384;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;32;-128,-448;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;40;-1008,208;Inherit;True;Property;_RoughnessTexture;Roughness Texture;2;0;Create;True;0;0;0;False;0;False;-1;fe92f4dfba538e848b75f579eb135bf1;fe92f4dfba538e848b75f579eb135bf1;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;13;-1232,-176;Inherit;True;Property;_MetallicTexture;Metallic Texture;1;0;Create;True;0;0;0;False;0;False;-1;fe92f4dfba538e848b75f579eb135bf1;fe92f4dfba538e848b75f579eb135bf1;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
